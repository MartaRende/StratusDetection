...
def get_map(datetime, var="CT"):
    ...
    # 2. Load NetCDF data
    # Parse the datetime string to build the file path
    ...
    # Timestamp to save
    target_time_str = datetime  # Use the function argument
    ...
    ax.legend()
    # Build the image path dynamically based on the datetime argument

    # Parse the datetime string
    dt_obj = dt.fromisoformat(datetime)
    # Example: 2024-11-16T11:30:00 -> 2024, 11, 16, 11, 30
    year = dt_obj.year
    month = f"{dt_obj.month:02d}"
    day = f"{dt_obj.day:02d}"
    ...
    # Compose filename and directory
...
if __name__ == "__main__":
    ...
    # Example usage
    # get_map("2024-11-16T09:30:00", var="CT")
    # get_map("2024-11-16T11:30:00", var="CT")
    # get_map("2024-11-16T14:30:00", var="CT")
    # get_map("2024-11-16T09:30:00", var="SU")
    # get_map("2024-11-16T11:30:00", var="SU")
    # get_map("2024-11-16T14:30:00", var="SU")
    # get_map("2023-01-06T09:30:00", var="CT")
    # get_map("2023-01-06T11:30:00", var="CT")
    # get_map("2023-01-06T14:30:00", var="CT")
    # get_map("2023-01-06T09:30:00", var="SU")
    # get_map("2023-01-06T11:30:00", var="SU")
    # get_map("2023-01-06T14:30:00", var="SU")
    # get_map("2023-01-26T09:30:00", var="CT")
    # get_map("2023-01-26T11:30:00", var="CT")
    # get_map("2023-01-26T14:30:00", var="CT")
    # get_map("2023-01-26T09:30:00", var="SU")
    # get_map("2023-01-26T11:30:00", var="SU")
    # get_map("2023-01-26T14:30:00", var="SU")
    # get_map("2023-02-08T09:30:00", var="CT")
    # get_map("2023-02-08T11:30:00", var="CT")
    # get_map("2023-02-08T14:30:00", var="CT")
    # get_map("2023-02-08T09:30:00", var="SU")
    # get_map("2023-02-08T11:30:00", var="SU")
    # get_map("2023-02-08T14:30:00", var="SU")
    # get_map("2024-11-11T09:30:00", var="CT")
    # get_map("2024-11-11T11:30:00", var="CT")
    # get_map("2024-11-11T14:30:00", var="CT")
    # get_map("2024-11-11T09:30:00", var="SU")
    # get_map("2024-11-11T11:30:00", var="SU")
    # get_map("2024-11-11T14:30:00", var="SU")
    # get_map("2024-11-11T09:30:00", var="CT")
    # get_map("2024-11-11T11:30:00", var="CT")
    # get_map("2024-11-11T14:30:00", var="CT")
    # get_map("2024-11-11T09:30:00", var="SU")
