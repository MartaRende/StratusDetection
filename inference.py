...
all_predicted = []
all_expected = []
months = [(2024, m) for m in range(1, 2)] +  [(2023, m) for m in range(9, 13)] +  [(2024, m) for m in range(1, 4)] + [(2024, m) for m in range(9, 13)]
...
global_metrics.plot_relative_error_for_specific_days(non_stratus_days, stratus_days="non_stratus_days_relative")
