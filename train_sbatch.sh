...
#module purge
apptainer exec --nv --bind /data/datasets/photocast:/data/datasets/photocast \
                       --bind /data/datasets/marta.rende:/data/datasets/marta.rende \
                       /data/datasets/marta.rende/train.sif python3 -u training.py 1 1 3
