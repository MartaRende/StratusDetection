...
#SBATCH --mem-per-cpu=24G         # memory per cpu-core (4G per cpu-core is default)
...
#module purge
apptainer exec --nv --bind /data/datasets/photocast:/data/datasets/photocast /data/datasets/marta.rende/train.sif python3 -u training.py 1 2 5